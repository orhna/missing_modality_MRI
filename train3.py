...
from nets.multimodal_swinunetr3 import Multimodal_SwinUNETR3 
...
if __name__ == "__main__":
    ...
    log_dir = f"./logs/testasval_evalall/{Training_config.experiment_name}_{_date}"
        ...
        for batch in tqdm(train_loader):
            ...
            if Training_config.deep_supervision:
                if Training_config.sep_dec:
                    ...
                    t2_loss = loss_function(sep_out[2], label)
                    sep_losses = f_loss + t1_loss +t2_loss
                    _w = 0.2
        ...
        if epoch % Training_config.val_interval == 0:# not epoch == 0 and
            ...
            with torch.no_grad():
                ...
                for val_data in val_loader:
                    ...
                    c_logits = sliding_window_inference(complete_modality_image, roi_size=(128,128,128), sw_batch_size=1, predictor= model)
