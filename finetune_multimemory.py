...
from nets.multimemory_net import multimemoryNet, multimemoryNetWrapper, drop_modality_image_channel, extract_complete_modality_features
...
if __name__ == "__main__":
    ...
    log_dir = f"./logs/recon_memory/{Training_config.experiment_name}_{_date}"
    ...
    rec_model = multimemoryNet(Training_config, device=device)
    rec_model.load_swinunetr_weights(load_model_path)
    wrapper = multimemoryNetWrapper(rec_model)
    ...
    for epoch in tqdm(range(epoched,epochs)):
        ...
        for batch in tqdm(train_loader):
            ...
            complete_modality_features = extract_complete_modality_features(rec_model.swinunetr,
                                                                        ...
                                                                        rec_model.diff_on)
            #print("remaining_channels:",remaining_channels)
            recon_complete_modality = rec_model(complete_modality_features, remaining_channels) 
            ...
            with torch.no_grad():
                ...
                for val_data in tqdm(val_loader):
                    ...
                    #    for channels in itertools.combinations(range(1), r):        
                            ...
                            wrapper.remaining_channels=remaining_channels
