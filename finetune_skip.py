...
from nets.mm_3Dunet_skip import mm_3Dunet, mm_3DUnetWrapper, drop_modality_image_channel, extract_complete_modality_features_level4, extract_complete_modality_features_level3
...
if __name__ == "__main__":
    ...
    for epoch in tqdm(range(epoched,epochs)):
        ...
        for batch in tqdm(train_loader):
            ...
            complete_modality_features_level4 = extract_complete_modality_features_level4(rec_model.swinunetr,
                                                                        complete_modality_image,
                                                                        rec_model.diff_on)
            missing_modality_features_level4 = extract_complete_modality_features_level4(rec_model.swinunetr,
                                                                        missing_modality_image,
                                                                        rec_model.diff_on)

            complete_modality_features_level3 = extract_complete_modality_features_level3(rec_model.swinunetr,
                                                                        complete_modality_image,
                                                                        rec_model.diff_on)
            missing_modality_features_level3 = extract_complete_modality_features_level3(rec_model.swinunetr,
                                                                        missing_modality_image,
                                                                        rec_model.diff_on)


            recon_complete_modality_level4, recon_complete_modality_level3 = rec_model(missing_modality_features_level4, missing_modality_features_level3) 
 
            mse_loss_level4 = criterionMSE(recon_complete_modality_level4, complete_modality_features_level4)
            mse_loss_level3 = criterionMSE(recon_complete_modality_level3, complete_modality_features_level3)
            ...
            """
            total_loss = mse_loss_level4 + mse_loss_level3 #+dice_loss  
            total_loss.backward()
            optimizer.step()
            
            #print(f"MSE loss: {mse_loss.item():.4f}")
            #print(f"Dice loss: {dice_loss.item():.4f}")
            epoch_mse_loss += mse_loss_level4.item() +  mse_loss_level3.item()
