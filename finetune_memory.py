...
from nets.memory_net import memoryNet, memoryNetWrapper, drop_modality_image_channel, extract_complete_modality_features
...
if __name__ == "__main__":
    ...
    rec_model = memoryNet(Training_config, device=device)
    rec_model.load_swinunetr_weights(load_model_path)
    wrapper = memoryNetWrapper(rec_model)
