...
from nets.mm_finalldm import mm_finalldm, drop_modality_image_channel, drop_modality_feature_channel
...
if __name__ == "__main__":
    ...
    ldm_model = mm_finalldm(Training_config, device=device)
        ...
        if not epoch == 0 and epoch % Training_config.val_interval == 0: # 
            ...
            with torch.no_grad():
                ...
                for val_data in val_loader:
                    ...
                    c_logits= ldm_model.swinunetr(complete_modality_image)
                    ...
                    m_hidden_states_out_m1 = ldm_model.swinunetr.swinViT_1(missing_modality_image[:,0:1,:,:], normalize=True)[4]
                    m_hidden_states_out_m2 = ldm_model.swinunetr.swinViT_2(missing_modality_image[:,1:2,:,:], normalize=True)[4]
                    m_hidden_states_out_m3 = ldm_model.swinunetr.swinViT_3(missing_modality_image[:,2:3,:,:], normalize=True)[4]
                    m_hidden_states_out_m4 = ldm_model.swinunetr.swinViT_4(missing_modality_image[:,3:4,:,:], normalize=True)[4]
                    m_dec4_m1 = ldm_model.swinunetr.encoder10_1(m_hidden_states_out_m1)
                    m_dec4_m2 = ldm_model.swinunetr.encoder10_2(m_hidden_states_out_m2)
                    m_dec4_m3 = ldm_model.swinunetr.encoder10_3(m_hidden_states_out_m3)
                    m_dec4_m4 = ldm_model.swinunetr.encoder10_4(m_hidden_states_out_m4)
                    ...
                    missing_modality_features = drop_modality_feature_channel(missing_modality_features,
                                                                            ldm_model.config.generation_mode,
                                                                            channels_to_drop,
                                                                            ldm_model.fs,
                                                                            ldm_model.mean_features)
                    
                    
                    if Training_config.diff_domain =="2D":
                        B,C,H,W,D=missing_modality_features.shape
                        missing_modality_features = missing_modality_features.reshape(B,C//4,H*4,W*4)
        
                        generated_features = ldm_model.diffusion.diff_sample(missing_modality_features).to(ldm_model.device)
                        
                        generated_features = generated_features.reshape(B,C,H,W,D)
                    elif Training_config.diff_domain =="3D":
                        generated_features = ldm_model.diffusion.diff_sample(missing_modality_features).to(ldm_model.device)


                    c_f_m_generated_logits = ldm_model.swinunetr(missing_modality_image, bottleneck=[generated_features,channels_to_drop])
                    m_logits = ldm_model.swinunetr(missing_modality_image)
